...
SECRET_KEY = 'django-insecure-xhiv4d)2o*7s^uvm6mw$(o((2+=9%0v@h+kw^b7#v6%h+faz_2'
...
TEMPLATES = [
    {
        ...
        'DIRS': ["C:/Users/diego/Documents/Visual Studio Code/proyecto-python/AppPrueba/templates"],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'AppPrueba.context_processors.avatar',
            ],
        },
    },
]
